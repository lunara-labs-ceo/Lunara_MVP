...
const LogoShowcase: React.FC = () => {
    const [selectedConcept, setSelectedConcept] = useState<string>('angular');
        ...
        <div className="min-h-screen bg-background p-4 md:p-8">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="text-center space-y-3">
                    <h1 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight">Lunara Labs Inc.</h1>
                ...
                {/* Main Showcase */}
                <div className="border border-border rounded-xl p-6 md:p-12 bg-card">
                ...
                <div className="space-y-4">
                    <h2 className="text-xl md:text-2xl font-semibold text-foreground">All Concepts</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {concepts.map(({ id, name, Component, desc }) => (
                            <div
                                key={id}
                                className="border border-border rounded-lg p-6 bg-card hover:bg-accent/50 transition-colors cursor-pointer"
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="border border-border rounded-lg p-6 bg-card space-y-4">
                        ...
                        <div className="flex flex-col items-center justify-center gap-6 min-h-[140px]">
                ...
                {/* Usage Examples */}
                <div className="space-y-4">
                    <h2 className="text-xl md:text-2xl font-semibold text-foreground">Usage Examples</h2>
                ...
                <div className="border border-border rounded-lg p-6 bg-card space-y-3">
                    ...
                    <ul className="text-sm text-muted-foreground space-y-2 list-disc list-inside">
                        ...
                        <li>Optimized for favicon sizes (16×16, 32×32, 48×48)</li>
