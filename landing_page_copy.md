# Lunara Landing Page Copy — Enterprise-Friendly Direction

## HERO SECTION

**Badge:** `Agentic BI for modern data teams`
...
**If you have logos:**
`Trusted by data teams at [Company 1] • [Company 2] • [Company 3]`

**If no logos yet:**
`Now in private beta with early-stage companies`
...
**Subhead:** Join the waitlist and be among the first to try Lunara.
