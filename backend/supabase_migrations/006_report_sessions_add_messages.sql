-- ============================================
-- Migration: 006_report_sessions_add_messages.sql
-- Create report_sessions (with messages JSONB) and report_items tables.
-- This replaces the unexecuted 005 migration and adds a messages column
-- so that chat history persists per report session.
-- ============================================

-- ----------------------------------------
-- report_sessions: stores report chat sessions per project
-- ----------------------------------------
