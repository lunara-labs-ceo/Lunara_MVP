                            ...
                            <div className="text-center sm:mx-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <a
                                        ...
                                        <span className="text-foreground text-sm">Now in private beta — apply for early access</span>
                                ...
                                <TextEffect
                                    ...
                                    speedSegment={0.3}
                                    as="h1"
                                    className="mx-auto mt-8 max-w-5xl text-balance text-5xl font-semibold md:text-7xl lg:mt-16 xl:text-[5.25rem]">
                        ...
                        <div className="pb-16 pt-16 md:pb-24">
                            <div className="px-6 lg:px-16">
                                <p className="text-muted-foreground text-center text-sm">
                                    Now in private beta with early-stage data teams
                                </p>
                                <div className="mt-8 flex flex-wrap justify-center gap-x-12 gap-y-6">
                                    {dataSources.map((ds) => (
                                        <div key={ds.name} className="flex items-center gap-2 opacity-50">
                                            <span className="size-2 rounded-full" style={{ background: ds.color }} />
                                            <span className="text-sm font-medium text-muted-foreground">{ds.name}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
