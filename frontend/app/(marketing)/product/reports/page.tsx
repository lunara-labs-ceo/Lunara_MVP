...
export const metadata: Metadata = {
  ...
  description:
    "Tell Lunara what you need. Quill runs analysis, generates charts, and writes narrative summaries. Two AI agents work together.",
}
...
const pipelineSteps = [
  ...
  {
    agent: "Quill Reporter",
    icon: PenLine,
    color: "text-primary",
    bgColor: "bg-primary/10",
    tasks: [
      "Takes Quill Analyst's results and structures a report",
    ...
    <>
      ...
      <section className="relative overflow-hidden pt-24 pb-16 md:pt-32 md:pb-24">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl">
            Tell Quill what you need. It runs the analysis,
      ...
      <SectionWrapper className="border-t border-border">
        <SectionHeader
          ...
          subtitle="Quill Analyst handles data. Quill Reporter handles storytelling. Together, they build complete reports."
        />
            ...
            <div className="mx-auto mt-8 flex max-w-md items-center gap-4">
              ...
              <div className="flex items-center gap-2 rounded-full border border-border bg-card px-4 py-2">
                ...
                <span className="font-mono text-xs text-muted-foreground">
                  Quill Analyst results flow to Quill Reporter
                </span>
              </div>
              <div className="h-px flex-1 bg-border" />
            </div>
